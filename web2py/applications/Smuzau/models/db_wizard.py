...
db.define_table('t_rating',
                Field('f_rating', type='integer', default=0,
                      label=T('rating')),
                Field('f_rated_count_5', type='integer', default=0,
                      label=T('how many times rated 5 star')),
                Field('f_rated_count_4', type='integer', default=0,
                      label=T('how many times rated 4 star')),
                Field('f_rated_count_3', type='integer', default=0,
                      label=T('how many times rated 3 star')),
                Field('f_rated_count_2', type='integer', default=0,
                      label=T('how many times rated 2 star')),
                Field('f_rated_count_1', type='integer', default=0,
